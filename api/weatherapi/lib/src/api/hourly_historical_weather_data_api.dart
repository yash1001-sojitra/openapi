...
class HourlyHistoricalWeatherDataApi {
  ...
  const HourlyHistoricalWeatherDataApi(this._dio, this._serializers);
  ...
  Future<Response<History>> historyHourlycityIdcityIdGet({
    ...
    final _path = r'/history/hourly?city_id={city_id}'.replaceAll(
        '{' r'city_id' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [History] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<History>> historyHourlycitycitycountrycountryGet({
    ...
    final _path = r'/history/hourly?city={city}&country={country}'
        .replaceAll(
            '{' r'city' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [History] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<History>> historyHourlylatlatlonlonGet({
    required double lat,
    required double lon,
    required String startDate,
    required String endDate,
    ...
    final _path = r'/history/hourly?lat={lat}&lon={lon}'
        .replaceAll(
            '{' r'lat' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [History] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<History>> historyHourlypostalCodepostalCodeGet({
    ...
    final _path = r'/history/hourly?postal_code={postal_code}'.replaceAll(
        '{' r'postal_code' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [History] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<History>> historyHourlystationstationGet({
    ...
    final _path = r'/history/hourly?station={station}'.replaceAll(
        '{' r'station' '}',
