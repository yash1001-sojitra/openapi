...
class BulkDownloadsApi {
  ...
  const BulkDownloadsApi(this._dio, this._serializers);
  ...
  ///
  /// Parameters:
  /// * [file] - Filename (ie. current.csv.gz)
  ...
  Future<Response<Error>> bulkFilesFileGet({
    ...
    final _path = r'/bulk/files/{file}'.replaceAll(
        '{' r'file' '}',
        encodeQueryParameter(_serializers, file, const FullType(String))
            .toString());
